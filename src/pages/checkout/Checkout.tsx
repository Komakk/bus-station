...
import { getDayAndMonth, getMinAndSec, getTime } from "../../../utils/utils";
...
export default function Checkout() {
  ...
  return (
    <>
      <Navigation />
      <main className="relative lg:top-14">
        <div className="md:w-200 lg:w-220 xl:w-[1170px] md:mx-auto h-14 flex justify-end items-center lg:hidden">
          <span className="z-10 fixed">
            <span
